...
wget -O /gpfs0/tals/projects/Analysis/DoChaP/DoChaP/Tool_code/OOP_project/data/orthology/H_sapiens.orthology.txt 'http://www.ensembl.org/biomart/martservice?query=<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE Query>
