...
class DomainOrganizer:
    ...
    def addDomain(self, domain):
        ...
        currDF = pd.DataFrame({"name": cdname, "other_name": oname, "description": ndesc, "CDD_id": ncdd,
                               "cdd": existExt[0], "pfam": existExt[1], "smart": existExt[2], "tigr": existExt[3],
                               "interpro": existExt[4]}, index=[currReg])
        self.allDomains = self.allDomains.append(currDF)
